...
if API_KEY and not API_KEY.startswith("YOUR"):
    ...
    print("⚠️ Skipping Twelve Data (No API key).")
...
if not SNOWFLAKE_READY:
    ...
    # FIX: Indented cleanly so it only fires when the library is confirmed active
    ...
    if not all([snowflake_user, snowflake_password, snowflake_account]):
        ...
        try:
            # Establish connection to your warehouse environment
